...
from wtforms.validators import DataRequired, Optional, Length, Regexp, Email, EqualTo
...
class EditProfileForm(FlaskForm):
  ...
  bio = StringField('Bio', validators=[Optional(), Length(0, 120)])
  submit = SubmitField()
