$(function () {
	...
	function update_my_collections_count() {
		$.ajax({
			type: 'GET',
			url: '/api/my-collections-count',
			success: function (data) {
				$('#my-collections-count').text(data.count)
			}
		});
	}

	function update_my_followings_count() {
		$.ajax({
			type: 'GET',
			url: '/api/my-followings-count',
			success: function (data) {
				$('#my-followings-count').text(data.count)
			}
		});
	}
	...
	if (is_authenticated && !is_development) {
