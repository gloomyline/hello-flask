...
class Permission(db.Model):
  ...
  roles = db.relationship('Role', secondary=roles_permission, back_populates='permissions')
...
class Role(db.Model):
  ...
  permissions = db.relationship('Permission', secondary=roles_permission, back_populates='roles')
...
class User(db.Model, UserMixin):
  ...
  member_since = db.Column(db.DateTime, default=datetime.now(UTC))
...
def delete_avatars(**kwargs):
  ...
  for filename in [target.avatar_s, target.avatar_m, target.avatar_l, target.avatar_rw]:
