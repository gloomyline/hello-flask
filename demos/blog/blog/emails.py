...
def _send_async_mail(app, messaeg):
...
def send_new_comment_email(post):
  post_url = url_for('essay.show_post', post_id=post.id, _external=True) + '#comments'
...
def send_new_reply_email(comment):
  post_url = url_for('essay.show_post', post_id=comment.post_id, _external=True) + '#comments'
